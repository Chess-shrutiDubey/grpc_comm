...
def analyze_performance():
    results_dirs = glob.glob("../results/vm_tests_*")
    if not results_dirs:
    ...
    try:
        ...
        output_file = os.path.join(latest_dir, 'vm_performance_analysis.png')
        ...
        summary.to_csv(os.path.join(latest_dir, 'vm_summary.csv'))
